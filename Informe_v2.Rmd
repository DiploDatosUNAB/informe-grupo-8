...
ls_genvar_estdesc$sexo %>% 
  ...
  geom_col()
ggsave(paste0("png/sexo_grafico_estandar","total_dosis", ".png"))
```
...
ls_genvar_estdesc$grupo_etario %>% 
  ...
  geom_col()
ggsave(paste0("png/grupo_etario_grafico_estandar","total_dosis", ".png"))
```
...
ls_genvar_estdesc$condicion_aplicacion %>% 
  ...
  geom_col()
ggsave(paste0("png/condicion_aplicacion_grafico_estandar","total_dosis", ".png"))
```
...
ls_genvar_estdesc$jurisdiccion_aplicacion %>% 
  ...
  geom_col()
ggsave(paste0("png/jurisdiccion_aplicacion_grafico_estandar","total_dosis", ".png"))
```
