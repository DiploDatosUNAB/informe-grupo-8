...
df_piramide_poblacional$n <- ifelse(df_piramide_poblacional$sexo == "M", -df_piramide_poblacional$n, df_piramide_poblacional$n)
...
pop_range_breaks <- pretty(seq(-max(pop_range_breaks), max(pop_range_breaks), by = 100), n = 7)
