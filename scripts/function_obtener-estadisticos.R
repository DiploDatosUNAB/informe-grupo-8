...
# resulta adecuado dejarlo por separado en la forma de una funcion que se describa como
...
obtener_estadisticos <- function(input_data = data, fecha_corte = max(fecha_aplicacion), vardin, varstat = orden_dosis, identificacion = id_persona){
  ...
  atexto[[vardin]] <- c(fecha_i, mas_abs, mas_rel)
  }
