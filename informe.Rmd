...
Se presentan las dimensiones de la base `data_per` y `data_reg`:
  ...
  * Cantidad de filas_observaciones (individuos) consideradas en `data_per` (n) es de: `r nrow(data_per)`.
  
  * Cantidad de filas_observaciones (registros) considerados en `data_reg` (n) es de: `r nrow(data_reg)`.
